...
All functions use x-api-key + x-api-secret headers. Bearer token endpoints as documented.`,
  ...
  },
  {
    ...
    memberImpact: "Members see a consent screen and approve access.",
  },
  {
    id: 4,
    ...
    path: "A",
    pathLabel: "New integrators only",
    prompt: `Add optional 'Referral Code' to signup. After account creation, call POST /api-referral-register. Store access_token, nocap_user_id, referral_code. Customer is auto-connected — no OAuth needed. If NoCap registration fails, don't block your signup.`,
    memberImpact: "New members get a NoCap wallet automatically if they enter a referral code.",
  },
  {
    id: 5,
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="text-muted-foreground">
                {[
                  ...
                  ["4 — Registration + Referral", "Yes", "Skip"],
