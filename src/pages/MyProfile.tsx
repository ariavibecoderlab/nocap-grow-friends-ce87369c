    ...
    <div className="min-h-screen bg-primary pb-20">
      <div className="px-4 pt-8 pb-6">
        <div className="mx-auto max-w-md">
          <div className="flex items-center gap-3">
            <Button variant="ghost" size="icon" className="text-white/50 hover:text-white hover:bg-white/10" onClick={() => navigate(-1)}>
              <ArrowLeft className="h-5 w-5" />
            </Button>
            <h1 className="font-display text-xl font-bold text-white">My Profile</h1>
            {!editing ? (
              <Button variant="ghost" size="icon" className="ml-auto text-white/50 hover:text-white hover:bg-white/10" onClick={() => setEditing(true)}>
                <Pencil className="h-4 w-4" />
              </Button>
            ) : (
              <Button variant="ghost" size="icon" className="ml-auto text-white/50 hover:text-white hover:bg-white/10" onClick={handleCancel}>
                <X className="h-4 w-4" />
              </Button>
            )}
          </div>
      ...
      <div className="mx-auto max-w-md px-4">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          {uploadingAvatar && <p className="mt-2 text-xs text-white/40">Uploading...</p>}
          <h2 className="mt-3 font-display text-lg font-bold text-white">{profile?.full_name || "Member"}</h2>
