    ...
    <div className="flex min-h-screen flex-col bg-foreground text-background">
      ...
      <section className="flex flex-1 flex-col items-center justify-center px-6 py-20 text-center md:py-28">
        ...
        <p className="mt-6 max-w-xl text-lg text-background/60">
          Members earn real cashback every time they pay. Merchants grow their
          customer base 3× faster with built-in referral rewards.
        </p>
        ...
        <div className="mt-16 grid grid-cols-3 gap-8 border-t border-background/10 pt-10 text-center md:gap-16">
          <div>
            ...
            <p className="mt-1 text-sm text-background/50">Cashback Per Pay</p>
          </div>
          <div>
      ...
      <section className="bg-background px-6 py-20 text-foreground md:px-12">
        <div className="mx-auto max-w-5xl">
          <h2 className="text-center font-display text-3xl font-bold md:text-4xl">
            Why Members Love <span className="text-primary">NOcap</span>
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-center text-muted-foreground">
            Every ringgit you spend earns you real rewards. No points, no gimmicks — just straight cashback into your wallet.
          </p>
      ...
      <section id="merchants" className="bg-foreground px-6 py-20 text-background md:px-12">
        <div className="mx-auto max-w-5xl">
          <h2 className="text-center font-display text-3xl font-bold md:text-4xl">
            Grow Your Business <span className="text-primary">3× Faster</span>
          </h2>
      ...
      <section className="bg-primary px-6 py-20 text-center text-foreground md:px-12">
        ...
        <p className="mx-auto mt-4 max-w-lg text-foreground/70">
          Join thousands of Malaysians already earning cashback on every purchase. It's free to sign up.
        </p>
        <Button
          size="lg"
